...
public class Lodowka {
	...
	public Lodowka() {
		mieso = new Kategoria("Mięso");
		nabial = new Kategoria("Nabiał");
	...
	private void init() {		
		...
		mieso.dodajProdukt(new Produkt("Kiełbasa",2,2));
	...
	public void wlacz(){
		Kategoria k;
		while(true) {
			System.out.println("Co chcesz zrobić? Wybierz opcje: ");
			System.out.println("\t(1) otworzyć lodówke");
			System.out.println("\t(2) dodac nowy produkt");
			System.out.println("\t(3) usunąć produkt");
			System.out.println("\t(9) zamknąć lodówkę");
			System.out.print("? ");
			...
			switch (o) {
				...
				case 9:
					return;
				default:
					System.err.println("Nie rozpoznaję opcji!");
			}
		}
	}
	...
	private Kategoria wybierzKategorie() {
		Kategoria k=null;
		System.out.println("Której kategorii użyć? Wybierz opcję: ");
